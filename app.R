  ...
  dashboardBody(
    ...
    tabPanel("About",  
               ...
               "The goal of this shiny app is to define herd immunity for covid-19.'Herd immunity', also known as 'population immunity', is the indirect protection from an infectious disease that happens when a population is immune either through vaccination or immunity developed through previous infection. WHO supports achieving 'herd immunity' through vaccination, not by allowing a disease to spread through any segment of the population, as this would result in unnecessary cases and deaths.
                Herd immunity against COVID-19 should be achieved by protecting people through vaccination, not by exposing them to the pathogen that causes the disease.For building my shiny app I have considered recent covid data of Bangladesh.
                The total population of Bangladesh is 166,822,384 among which 19,332,082 people are fully vaccinated which is about 11.7% till 10/22/2021(updated online). 
                Here I have conducted the SIR Model in order to gain herd immunity against Covid-19.The details about SIR model is given in README.md. Since the vaccination rate is too low at this point and we are way too much behind attaining herd immunity,but vaccination process is still ongoing throughout the country and we are supposed to vaccinated majority of the population within a very short term. This is an dynamic shiny app showing how increasing vaccination will lead us to attain herd immunity. 
